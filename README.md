...
Wrap Toggled!
git fetch upstream/main	Used to grab upstream branches	
1
...
Wrap Toggled!
git merge upstream/main	Merges changes from the 'upstream/main' branch to the current branch	
1
...
Wrap Toggled!
git pull downstream	Pulls changes from a downstream repository, specifically from the main branch of that repository	
1
